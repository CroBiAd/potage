...
public class Location_cMFilter implements Serializable {
    ...
    private ArrayList<Double> cM_Range;

    public Location_cMFilter() {
        this.cM_Range = new ArrayList<>();
    }

    public Location_cMFilter(Location_cMFilter another) {
        this.cM_Range = new ArrayList<>();
        for (Double cM : another.getcM_Range()) {
            add_cM_valuesToMinMaxAnd_cMRanges(cM);
        }
    }
...
//    }
    ...
    public void add_cM_valuesToMinMaxAnd_cMRanges(Double cM) {
        cM = reusable.CommonMaths.round(cM, 3);
        if (cM_min == null) {
            cM_min = cM;
            cM_max = cM;
...
//            cM_original_max = cM_original;
            ...
            cM_min = cM < cM_min ? cM : cM_min;
            cM_max = cM > cM_max ? cM : cM_max;
//            if (cM < cM_min) {
...
//    }
    public void setcM_min(Double cM_min) {
        this.cM_min = reusable.CommonMaths.round(cM_min, 3);
    }

    public void setcM_max(Double cM_max) {
        this.cM_max = reusable.CommonMaths.round(cM_max, 3);
    }
